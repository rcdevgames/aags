...
class Captcha {
   ...
   *
   * @see Captcha::$text_transparency_percentage
   * @var boolean
   */
   ...
   *
   * @see Captcha::$use_transparent_text
   * @var int
   */
   ...
   *
   * @see Captcha::$line_color
   * @see Captcha::$line_distance
   * @see Captcha::$line_thickness
   * @see Captcha::$draw_lines_over_text
   * @var boolean
   */
  var $draw_lines = true;
